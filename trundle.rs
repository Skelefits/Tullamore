...
pub fn drawtitlebar<C: Connection>(xconnection: &C, window: u32, width: i16, height: i16, gc_highlight: u32, gc_lowlight: u32, gc_highbackground: u32, gc_lowbackground: u32, gc_titlebar: u32, poly_lowlight: &mut Vec<Segment>) {
...
pub fn drawxicon<C: Connection>(xconnection: &C, window: u32, startx: i16, starty: i16, size: i16) -> [Segment; 4] {
	let yheight = starty + size;
	let xlength = startx + size;
	let startx1 = startx + 1;
	let xlength1 = xlength + 1;
    [
		Segment { x1: startx, y1: starty, x2: xlength1, y2: yheight },
		Segment { x1: startx, y1: yheight, x2: xlength1, y2: starty },
		Segment { x1: startx1, y1: starty, x2: xlength, y2: yheight },
		Segment { x1: startx1, y1: yheight, x2: xlength, y2: starty },
    ]
}

pub fn drawfullscreenicon<C: Connection>(xconnection: &C, window: u32, startx: i16, starty: i16, size: i16) -> [Segment; 5] {
	let yheight = starty + size;
	let xlength = startx + size;
	let starty1 = starty + 1;
	[
		Segment { x1: startx, y1: starty, x2: xlength, y2: starty },
		Segment { x1: xlength, y1: starty, x2: xlength, y2: yheight },
		Segment { x1: xlength, y1: yheight, x2: startx, y2: yheight },
		Segment { x1: startx, y1: yheight, x2: startx, y2: starty1 },
		Segment { x1: startx, y1: starty1, x2: xlength - 1, y2: starty1 },
	]
}

pub fn drawminimiseicon<C: Connection>(xconnection: &C, window: u32, startx: i16, starty: i16, size: i16) -> [Segment; 2] {
	let yheight = starty + size;
	let xlength = startx + size;
	[
		Segment { x1: startx, y1: yheight - 1, x2: xlength, y2: yheight - 1 },
		Segment { x1: startx, y1: yheight, x2: xlength, y2: yheight },
	]
}
